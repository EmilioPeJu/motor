...
Version:	1.8.4.4.2.2
Modified By:	sluiter
Last Modified:	2004/05/24 21:19:12
*/
 ...
 * .07 07/01/03 rls - recv_mess() eats the controller error response, outputs
 ...
 * .10 05/24/04 rls - Error introduced in #07 above; confusing valid with
 *			"system error" response from controller.
 */
