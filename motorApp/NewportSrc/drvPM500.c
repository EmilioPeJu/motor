 ...
 * .04 07/01/03 rls recv_mess() eats the controller error response, outputs
 *			an error message and retries.
 * .05 12-17-03 rls Fixed DLY; removed ReadbackDelay variable.
 * .06 02-06-04 rls Eliminate erroneous "Motor motion timeout ERROR".
 */
