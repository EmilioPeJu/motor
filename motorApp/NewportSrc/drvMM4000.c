...
Version:	1.9.4.6.2.1
Modified By:	sluiter
Last Modified:	2004/02/10 17:06:45
*/
 ...
 *		node.
 * .07 05-15-03 mlr Added a final poll of motor status if drvMM4000ReadbackDelay is
 ...
 * .08 12-17-03 rls Error check on searching "ident" for model.
