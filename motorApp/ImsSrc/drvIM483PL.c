...
Version:	1.7.4.2.2.1
Modified By:	sluiter
Last Modified:	2004/02/10 17:04:06
*/
 ...
 *		    from send_mess().
 * .04 12-17-03 rls Fixed DLY; removed ReadbackDelay variable.
 * .05 02-06-04 rls Eliminate erroneous "Motor motion timeout ERROR".
 */
